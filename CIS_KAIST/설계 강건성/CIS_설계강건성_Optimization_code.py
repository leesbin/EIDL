...
source_size = mp.Vector3(Sx , 0, 0) # Source 크기

src_0 = mp.GaussianSource(frequency=frequency, fwidth=fwidth, is_integrated=True) # Source 설정

k_point_0 = mp.Vector3(y = -1).rotate(mp.Vector3(z=1), 0) # Bloch boundary condition을 위한 k point 설정 입사각 0도
