...
###########################################################################
    ...
    if True: ##### Set main parameters ############################################################################################################################                                                                                                                                  
        ...
        ml_thickness_1 = round(o_grid * i, 2) # multi layer thickness 200 nm 
...
######################################################################################################
    ...
    if ML: # Multi Design Region  #################################################################################################################################
        design_variables_0 = mp.MaterialGrid(mp.Vector3(Nx, Ny), SiO2, SiN, grid_type="U_MEAN",do_averaging=False)
        ...
        design_variables_1 = mp.MaterialGrid(mp.Vector3(Nx, Ny), SiO2, SiN, grid_type="U_MEAN",do_averaging=False)
        ...
        design_variables_2 = mp.MaterialGrid(mp.Vector3(Nx, Ny), SiO2, SiN, grid_type="U_MEAN",do_averaging=False)
        ...
        design_variables_3 = mp.MaterialGrid(mp.Vector3(Nx, Ny), SiO2, SiN, grid_type="U_MEAN",do_averaging=False)
        ...
        design_variables_4 = mp.MaterialGrid(mp.Vector3(Nx, Ny), SiO2, SiN, grid_type="U_MEAN",do_averaging=False)
    ...
    if Norm: ##### normalization flux calculation #################################################################################################################
        ...
        b_0_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_0_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_0_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_0_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_0_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_0_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[1], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_1_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_1_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_1_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_1_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_1_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_1_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[2], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_2_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_2_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_2_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_2_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_2_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_2_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[3], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_3_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_3_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_3_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_3_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_3_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_3_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[4], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_4_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_4_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_4_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        b_4_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_4_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        b_4_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[5], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_0_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_0_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_0_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_0_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_0_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_0_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[10], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_1_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_1_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_1_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_1_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_1_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_1_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[11], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_2_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_2_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_2_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_2_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_2_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_2_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[12], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_3_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_3_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_3_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_3_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_3_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_3_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[13], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_4_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_4_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_4_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        g_4_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_4_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        g_4_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[14], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_0_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_0_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_0_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_0_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_0_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_0_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[18], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_1_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_1_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_1_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_1_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_1_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_1_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[19], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_2_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_2_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_2_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_2_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_2_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_2_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[20], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_3_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_3_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_3_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_3_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_3_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_3_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[21], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_4_tran_Ex = sim.add_dft_fields([mp.Ex], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_4_tran_Ey = sim.add_dft_fields([mp.Ey], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_4_tran_Ez = sim.add_dft_fields([mp.Ez], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)

        r_4_tran_Hx = sim.add_dft_fields([mp.Hx], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_4_tran_Hy = sim.add_dft_fields([mp.Hy], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
        r_4_tran_Hz = sim.add_dft_fields([mp.Hz], frequencies[22], 0 , 1, center=mp.Vector3(0, 0, round(-Sz/2 + Lpml + 1/resolution,2)), size=mp.Vector3(Sx, Sy, 0), yee_grid=True)
...
####################################################################################################
    ...
    Momentum_dJ_du = False # Momentum for dJ_du
