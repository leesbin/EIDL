...
# In[71]:
	...
	opt.sim.run(until_after_sources=mp.stop_when_fields_decayed(10,mp.Ez,pt,1e-7))
	...
	print(np.mean((Tg)[0:100]))
	print(np.mean((Tg)[100:200]))
	print(np.mean((Tg)[200:300]))


	# In[111]:


	print(max((Tr-Tg)[0:100]))
	print(max((Tb-Tg)[200:300]))
	print(max((Tg-Tr)[100:200]))
