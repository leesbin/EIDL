...
if mp.am_master():
    ...
    plt.axis([0.40, 0.70, 0, 1])
    plt.xlabel("wavelength (μm)")
    plt.ylabel("OpticalEffeciency")
    plt.fill([0.40, 0.40, 0.50, 0.50], [0.0, 1.0, 1.0, 0.0], color='lightblue', alpha=0.5)
    plt.fill([0.50, 0.50, 0.60, 0.60], [0.0, 1.0, 1.0, 0.0], color='lightgreen', alpha=0.5)
    plt.fill([0.60, 0.60, 0.70, 0.70], [0.0, 1.0, 1.0, 0.0], color='lightcoral', alpha=0.5)
    plt.legend(loc="upper right")
    #plt.show()
    plt.savefig("OpticalEffeciency.png")



print("R pixel mean: {}".format(np.mean(Tr[:100])))
print("G pixel mean: {}".format(np.mean(Tg[100:200])))
print("B pixel mean: {}".format(np.mean(Tb[200:300])))



print("R pixel OE max: {}".format(max(Tr)))
print("G pixel OE max: {}".format(max(Tg)))
print("B pixel OE max: {}".format(max(Tb)))


print("R pixel crosstalk: {}".format(np.mean(Tr[100:300])))
print("G pixel crosstalk: {}".format(np.mean((Tg[0:100]+Tg[200:300])/2)))
print("B pixel crosstalk: {}".format(np.mean(Tb[0:200])))
