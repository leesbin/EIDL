...
# In[112]:
#First FoM: 25.641630952126658
#FoM: 156.67512666173636

#Elapsed run time = 1481.6564 s


# 시뮬레이션 라이브러리 불러오기 4_core_1508.8093 s
...
geometry = [
    ...
    mp.Block(
        center=mp.Vector3(0, -Sy/2 + pml_size, 0), size=mp.Vector3(Sx, 2, 0), material=SiPD
    ),
    # mp.Block(
...
monitor_position_0, monitor_size_0 = mp.Vector3(-1, -Sy/2 + pml_size * 2 + 0.5/resolution), mp.Vector3(0.01,0) 
monitor_position_1, monitor_size_1 = mp.Vector3(0, -Sy/2 + pml_size * 2 + 0.5/resolution), mp.Vector3(0.01,0) 
monitor_position_2, monitor_size_2 = mp.Vector3(1, -Sy/2 + pml_size * 2 + 0.5/resolution), mp.Vector3(0.01,0)
