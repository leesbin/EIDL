...
# In[112]:
# First FoM: 8.49759321536715
# Current FoM: 145.35897985544884

# Elapsed run time = 1462.1490 s
...
src_0 = mp.GaussianSource(frequency=fcen_red1, fwidth=fwidth_red1, is_integrated=True)
src_1 = mp.GaussianSource(frequency=fcen_green1, fwidth=fwidth_green1, is_integrated=True)
src_2 = mp.GaussianSource(frequency=fcen_blue1, fwidth=fwidth_blue1, is_integrated=True)
