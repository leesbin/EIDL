...
def J_0(fields):
    return 4.257666652364128 - npa.sum((npa.abs(fields[:,1]) ** 2))
def J_1(fields):
    return 2.7407225191182802 - npa.sum((npa.abs(fields[:,1]) ** 2))
def J_2(fields):
    return 1.5701799429277332 - npa.sum((npa.abs(fields[:,1]) ** 2))
