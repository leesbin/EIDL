...
source1 = [mp.Source(src_1, component=mp.Ez, size=source_size, center=source_center, amplitude=1.246388100063196)]
source2 = [mp.Source(src_2, component=mp.Ez, size=source_size, center=source_center, amplitude=1.6466872211860322)]
...
def J_0(fields):
    return - npa.sum((npa.abs(fields[:,1]) ** 2))
def J_1(fields):
    return - npa.sum((npa.abs(fields[:,1]) ** 2))
def J_2(fields):
    return - npa.sum((npa.abs(fields[:,1]) ** 2))
