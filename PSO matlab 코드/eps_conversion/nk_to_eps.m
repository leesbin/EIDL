...
material.lambda= linspace(380e-9,780e-9,100);
...
fp100=fopen('TiO2_lambda_eps1_eps2.txt','w');
fp101=fopen('TiO2_meep_a_eps1_eps2.txt','w');
fp102=fopen('TiO2_meep_f_eps1_eps2.txt','w');
