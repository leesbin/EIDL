...
for seq=0:0
    ...
    if Load_input==1
        ...
        for Forward_input_load=0:0       
            Ex_o= ["Ex_Input_H_field.h5"];                           %Hx
            hinfo_Ex_o= hdf5info("Ex_Input_H_field.h5");
            Ey_o= ["Ey_Input_H_field.h5"];                           %Hy
            hinfo_Ey_o= hdf5info("Ey_Input_H_field.h5");
            Ez_o= ["Ez_Input_H_field.h5"];                            %Ez
            hinfo_Ez_o= hdf5info("Ez_Input_H_field.h5");
        ...
        for Input_pcolor_ver=0:0
                if View_input_pcolor==1    
                        ...
                        % view(2);% = view(0,90) < 방위각, 고도각
                        title("|Ez| (input)")
                        sgtitle("Incidence field (z= input plane)")
                        axis off
                        grid off 
                        cd Result/
        ...
        for Backward_input_load=0:0       
            Ex_o= ["Ex_Input_V_field.h5"];                           %Hx
            hinfo_Ex_o= hdf5info("Ex_Input_V_field.h5");
            Ey_o= ["Ey_Input_V_field.h5"];                           %Hy
            hinfo_Ey_o= hdf5info("Ey_Input_V_field.h5");
            Ez_o= ["Ez_Input_V_field.h5"];                            %Ez
            hinfo_Ez_o= hdf5info("Ez_Input_V_field.h5");
    ...
    for output_load=0:0
        %free space
        Ex_o= ["Ex_Output_H_field.h5"];                           %Hx
        hinfo_Ex_o= hdf5info("Ex_Output_H_field.h5");
        Ey_o= ["Ey_Output_H_field.h5"];                           %Hy
        hinfo_Ey_o= hdf5info("Ey_Output_H_field.h5");
        Ez_o= ["Ez_Output_H_field.h5"];                            %Ez
        hinfo_Ez_o= hdf5info("Ez_Output_H_field.h5");
    ...
    for output_pcolor_ver=0:0
        if View_output_pcolor==1
                        ...
                        % view(2);% = view(0,90) < 방위각, 고도각
                        title("|E_z| (output)")
                        sgtitle("output field (z=focal point)")
                        axis off
                        grid off 
                        cd Result/
    ...
    for output_load=0:0
        %free space
        Ex_o= ["Ex_Output_V_field.h5"];                           %Hx
        hinfo_Ex_o= hdf5info("Ex_Output_V_field.h5");
        Ey_o= ["Ey_Output_V_field.h5"];                           %Hy
        hinfo_Ey_o= hdf5info("Ey_Output_V_field.h5");
        Ez_o= ["Ez_Output_V_field.h5"];                            %Ez
        hinfo_Ez_o= hdf5info("Ez_Output_V_field.h5");
...
%         
            ...
            subplot(1,2,2)
                        PC=pcolor(Rev_out);%intencity
                        PC.EdgeColor='none';
                        
                        hold on
                        c = colorbar();
                        colormap(subplot(1,2,2),"turbo");
                             caxis([0 1])
                ...
                pbaspect([X Y 1]) %figure 종횡비
                %view(2);% = view(0,90) < 방위각, 고도각
                title("Design space E")
                sgtitle("Transmission = "+T+"%, Reflection = "+R+"%, Eff = "+Eff+"%, Loss = "+L+" [%].")
                        axis off
                        grid off 
                        cd Result/
