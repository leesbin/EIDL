...
f0_SiN_meep = [7.7377859974045755, 8.506180133298983];
gamma_SiN_meep = [0.0, 0.0, 0.0]; % it is already devided by 2pi
sigma_SiN_meep = [1.147707903082043, 1.3401524904921767];

eps_SiN_meep = 1 + (sigma_SiN_meep(1)*f0_SiN_meep(1)^2)./(f0_SiN_meep(1)^2 - f.^2 - 1i*f.*gamma_SiN_meep(1));
eps_SiN_meep = eps_SiN_meep + (sigma_SiN_meep(2)*f0_SiN_meep(2)^2)./(f0_SiN_meep(2)^2 - f.^2 - 1i*f.*gamma_SiN_meep(2));
