...
f0_TiO2_meep = [4.348157694697662, 3.0537170282341854];
gamma_TiO2_meep = [0.0, 0.0, 0.0]; % it is already devided by 2pi
sigma_TiO2_meep = [4.365571330405097, 0.4698502638787203];

eps_TiO2_meep = 1 + (sigma_TiO2_meep(1)*f0_TiO2_meep(1)^2)./(f0_TiO2_meep(1)^2 - f.^2 - 1i*f.*gamma_TiO2_meep(1));
eps_TiO2_meep = eps_TiO2_meep + (sigma_TiO2_meep(2)*f0_TiO2_meep(2)^2)./(f0_TiO2_meep(2)^2 - f.^2 - 1i*f.*gamma_TiO2_meep(2));
