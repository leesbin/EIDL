...
%% red
f0_G_filter_meep = [2.500000000000000, 2.352941176470588, 2.222222222222222, 2.105263157894737, 1.538461538461538, 1.481481481481481, 1.428571428571429];
gamma_G_filter_meep = [0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983];
sigma_G_filter_meep = [0.05, 0.04, 0.03, 0.03, 0.03, 0.04, 0.05];

eps_G_filter_meep = 1.0 + (sigma_G_filter_meep(1)*f0_G_filter_meep(1)^2)./(f0_G_filter_meep(1)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(1));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(2)*f0_G_filter_meep(2)^2)./(f0_G_filter_meep(2)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(2));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(3)*f0_G_filter_meep(3)^2)./(f0_G_filter_meep(3)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(3));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(4)*f0_G_filter_meep(4)^2)./(f0_G_filter_meep(4)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(4));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(5)*f0_G_filter_meep(5)^2)./(f0_G_filter_meep(5)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(5));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(6)*f0_G_filter_meep(6)^2)./(f0_G_filter_meep(6)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(6));
eps_G_filter_meep = eps_G_filter_meep + (sigma_G_filter_meep(7)*f0_G_filter_meep(7)^2)./(f0_G_filter_meep(7)^2 - f.^2 - 1i*f.*gamma_G_filter_meep(7));
...
%     SiN_eps = @(w)(real(eps_sin_meep(k)) + imag(eps_sin_meep(k))*1.0i);
    G_filter_eps = @(w)(real(eps_G_filter_meep (k)) + imag(eps_G_filter_meep (k))*1.0i);
%     Si_eps = @(w)(data_eps_re(644+k,2) + 1i*data_eps_im(644+k,2)); % 540-560nm range
%     Si_eps = @(w)(data_eps_re(k,2) + 1i*data_eps_im(k,2));

    layerMaterials = {Vacuum, G_filter_eps,  Vacuum};
