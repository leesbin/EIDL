...
%% red
f0_R_filter_meep = [2.500000000000000, 2.352941176470588, 2.222222222222222, 2.105263157894737, 2.0, 1.904761904761905, 1.818181818181818];
gamma_R_filter_meep = [0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983, 0.212353822772983];
sigma_R_filter_meep = [0.05, 0.04, 0.03, 0.03, 0.03, 0.03, 0.03];

eps_R_filter_meep = 1.0 + (sigma_R_filter_meep(1)*f0_R_filter_meep(1)^2)./(f0_R_filter_meep(1)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(1));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(2)*f0_R_filter_meep(2)^2)./(f0_R_filter_meep(2)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(2));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(3)*f0_R_filter_meep(3)^2)./(f0_R_filter_meep(3)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(3));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(4)*f0_R_filter_meep(4)^2)./(f0_R_filter_meep(4)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(4));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(5)*f0_R_filter_meep(5)^2)./(f0_R_filter_meep(5)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(5));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(6)*f0_R_filter_meep(6)^2)./(f0_R_filter_meep(6)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(6));
eps_R_filter_meep = eps_R_filter_meep + (sigma_R_filter_meep(7)*f0_R_filter_meep(7)^2)./(f0_R_filter_meep(7)^2 - f.^2 - 1i*f.*gamma_R_filter_meep(7));
...
%     SiN_eps = @(w)(real(eps_sin_meep(k)) + imag(eps_sin_meep(k))*1.0i);
    R_filter_eps = @(w)(real(eps_R_filter_meep (k)) + imag(eps_R_filter_meep (k))*1.0i);
%     Si_eps = @(w)(data_eps_re(644+k,2) + 1i*data_eps_im(644+k,2)); % 540-560nm range
%     Si_eps = @(w)(data_eps_re(k,2) + 1i*data_eps_im(k,2));

    layerMaterials = {Vacuum, R_filter_eps,  Vacuum};
