...
f0_HfO2_meep = [6.951670963192224,  9.138192089889];
gamma_HfO2_meep = [0.0, 0.0, 0.0]; % it is already devided by 2pi
sigma_HfO2_meep = [0.7839356658238223, 1.7078673883568463];

eps_HfO2_meep = 1 + (sigma_HfO2_meep(1)*f0_HfO2_meep(1)^2)./(f0_HfO2_meep(1)^2 - f.^2 - 1i*f.*gamma_HfO2_meep(1));
eps_HfO2_meep = eps_HfO2_meep + (sigma_HfO2_meep(2)*f0_HfO2_meep(2)^2)./(f0_HfO2_meep(2)^2 - f.^2 - 1i*f.*gamma_HfO2_meep(2));
