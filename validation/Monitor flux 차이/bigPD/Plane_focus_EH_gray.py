...
design_dir = "./Plane_focus_EH_gray/"
...
def J_0(fields_0, fields_1, fields_2, fields_0_h, fields_1_h, fields_2_h):
    red = npa.sum(npa.abs(fields_0[21:30,:]*(npa.real(fields_0_h[21:30,:])-npa.imag(fields_0_h[21:30,:])* 1j)))
    green = npa.sum(npa.abs(fields_1[11:20,:]*(npa.real(fields_1_h[11:20,:])-npa.imag(fields_1_h[11:20,:])* 1j)))
    blue = npa.sum(npa.abs(fields_2[1:10,:]*(npa.real(fields_2_h[1:10,:])-npa.imag(fields_2_h[1:10,:])* 1j)))
