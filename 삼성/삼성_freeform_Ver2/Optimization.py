...
###########################################################################
    ...
    if True: #####  Set wavelengths and sources  ##################################################################################################################
        ...
        wavelengths = np.array([
                wavelengths_pieces[3], wavelengths_pieces[4], wavelengths_pieces[5], wavelengths_pieces[6], wavelengths_pieces[7],
                wavelengths_pieces[13], wavelengths_pieces[14], wavelengths_pieces[15], wavelengths_pieces[16], wavelengths_pieces[17],
                wavelengths_pieces[23], wavelengths_pieces[24], wavelengths_pieces[25], wavelengths_pieces[26], wavelengths_pieces[27]
        ])
