...
for i in x_list:
    ...
    if simcondition:  
        ...
        if True: ##### Set main parameters ############################################################################################################################                                                                                                                                  
            ...
            el_thickness = round(o_grid * 0, 2) # etch layer thickness 40 nm
            ...
            sp_size = round(o_grid * 30, 2) # subpixel size 560 nm
        ...
        if True: #####  Set geometry  ################################################################################################################################
            # structure load
            structure_weight_0 = np.loadtxt('structure_0_47.txt')
            structure_weight_1 = np.loadtxt('structure_1_47.txt')
            structure_weight_2 = np.loadtxt('structure_2_47.txt')
            structure_weight_3 = np.loadtxt('structure_3_47.txt')
            structure_weight_4 = np.loadtxt('structure_4_47.txt')
