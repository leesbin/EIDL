...
for i in x_list:
    ...
    if simcondition:  
        ...
        if True: ##### Set main parameters ############################################################################################################################                                                                                                                                  
            ...
            if FL:                                                                               
                fl_thickness = round(o_grid * 100, 2) # focal layer thickness 800 nm              
            else:                                                                                
                fl_thickness = round(o_grid * 0, 2)
            
            ml_thickness_1 = round(o_grid * 20, 2) # multi layer thickness 200 nm 
            ml_thickness_2 = round(o_grid * 0, 2) # multi layer thickness 200 nm 
            ml_thickness_3 = round(o_grid * 0, 2) # multi layer thickness 200 nm 
            ml_thickness_4 = round(o_grid * 0, 2) # multi layer thickness 200 nm  
