...
for i in x_list:
    ...
    if Opticaleff:
        ...
        if mp.am_master():
            ...
            plt.plot(wl, Tgr*400, "g", label="Gb")
            plt.plot(wl, Tb*400, "b", label="B")
            plt.plot(wl, Tgb*400, color='limegreen', label="Gr")
            
            plt.axis([0.40, 0.70, 0, 400])
            plt.xlabel("Wavelength (μm)")
            plt.ylabel("Efficiency")
            plt.fill([0.425, 0.425, 0.485, 0.485], [-0.03, 400.03, 400.03, -0.03], color='lightblue', alpha=0.5)
            plt.fill([0.515, 0.515, 0.575, 0.575], [-0.03, 400.03, 400.03, -0.03], color='lightgreen', alpha=0.5)
            plt.fill([0.595, 0.595, 0.655, 0.655], [-0.03, 400.03, 400.03, -0.03], color='lightcoral', alpha=0.5)
        ...
        if mp.am_master():
            plt.figure(dpi=150)
            plt.plot(wl, Tr*400, "r",)
            plt.plot(wl, (Tg+Tg0)*400, "g",)
            plt.plot(wl, Tb*400, "b",)
            plt.plot(wl, Trt*400, "r--",)
            plt.plot(wl, (Tgt+Tg0t)*400, "g--",)
            plt.plot(wl, Tbt*400, "b--",)
            plt.plot(wl, DTIloss*400, "k",)
        ...
        if mp.am_master():
            plt.figure(dpi=150)
            plt.plot(wl, Tr*400, "r",)
            plt.plot(wl, Tg*400, "g",)
            plt.plot(wl, Tb*400, "b",)
            plt.plot(wl, Trt*400, "r--",)
            plt.plot(wl, Tgt*400, "g--",)
            plt.plot(wl, Tbt*400, "b--",)
            plt.plot(wl, DTIloss*400, "k",)
            #plt.plot(wl, Tg0, color='limegreen', label="Greenpixel2")
        ...
        if mp.am_master():
            plt.figure(dpi=150)
            plt.plot(wl, Tr*400, "r", label="R")
            plt.plot(wl, (Tgr+Tgb)*400, "g", label="Gb")
            plt.plot(wl, Tb*400, "b", label="B")
