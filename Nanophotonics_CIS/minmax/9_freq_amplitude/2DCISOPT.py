...
source0 = [mp.Source(src_0, component=mp.Ez, size=source_size, center=source_center, amplitude = 0.980387163 )]
source1 = [mp.Source(src_1, component=mp.Ez, size=source_size, center=source_center, amplitude = 1.156666106 )]
source2 = [mp.Source(src_2, component=mp.Ez, size=source_size, center=source_center, amplitude = 1.409492548)]
...
opt0 = mpa.OptimizationProblem(
    ...
    decay_by=1e-2, # 모니터에 남아있는 필드 값의 비율
)
