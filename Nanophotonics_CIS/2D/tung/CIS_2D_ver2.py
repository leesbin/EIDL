...
Nx = int(round(design_region_resolution * (design_region_width-metal_gap*2))) + 1
...
design_region = mpa.DesignRegion(
    ...
    volume=mp.Volume(
        ...
        size=mp.Vector3(design_region_width-metal_gap*2, design_region_height, 0),
    ),
)
...
def mapping(x, eta, beta):
    ...
    filtered_field = mpa.conic_filter(
        x,
        filter_radius,
        design_region_width-metal_gap*2,
...
geometry = [
    ...
    mp.Block(
        center=mp.Vector3(-Sx/2 + metal_gap/2, -Sy/2 +  PDsize + design_region_height/2, 0), size=mp.Vector3(metal_gap, design_region_height, 0), material = W
    ),
    mp.Block(
        center=mp.Vector3(Sx/2 - metal_gap/2, -Sy/2 +  PDsize + design_region_height/2, 0), size=mp.Vector3(metal_gap, design_region_height, 0), material = W
    ),
