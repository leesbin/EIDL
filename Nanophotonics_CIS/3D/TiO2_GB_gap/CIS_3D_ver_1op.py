...
# Resoultion 20 
# RGGB pattern
# Elapsed run time = 432705.9034 s
...
Nx = int(round(design_region_resolution * (design_region_width_x-air_gap*2))) + 1
Ny = int(round(design_region_resolution * (design_region_width_y-air_gap*2))) + 1
...
def mapping(x, eta, beta):
    ...
    while z < Nz:
        ...
        filtered_field = mpa.conic_filter(
            x1,
            filter_radius,
            design_region_width_x-air_gap*2,
            design_region_width_y-air_gap*2,
