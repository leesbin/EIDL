...
red_middle  = [1 0 0];
red = [0.5 0 0];
white_middle= [0.2 0 0];
white_middle1= [0 0 0.2];
blue = [0 0 0.5];
blue_middle = [0 0 1];
white2 = [0.4 0.4 1];
BW= [0.5 0.5 1];
blue_bottom = [0.1 0.1 1];
Yellow=[0 0 0];
%% color interpolation 
color_num = 251;  
color_input = [white; BW; white2; blue_bottom; blue_middle; blue; white_middle1; Yellow; white_middle; red; red_middle; red_top; white1; RW; white];
oldsteps = [-1 -0.8  -0.7 -0.5 -0.3 -0.15 -0.07 0 0.07 0.15 0.3 0.5 0.7 0.8 1];   % Location of setted color 
